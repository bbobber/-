    ...
    def move(self, screen_width, screen_height, surface, target, round_over):
        ...
        if self.attacking == False and self.alive == True and round_over == False:
            ...
            if self.player == 1:
                ...
                if target.rect.centerx - 40 > self.rect.centerx:
                    dx = spedZ
                    self.running = True
                elif target.rect.centerx + 40 < self.rect.centerx:
                    dx = -spedZ
                    self.running = True
                else:
                    self.attack(target)
        ...
        if self.rect.bottom + dy > screen_height - 145:
            self.vel_y = 0
            self.jump = False
            dy = screen_height - 145 - self.rect.bottom
