...
fighter_1 = Fighter(1, 0, 275, False, WARRIOR_DATA, warrior_sheet, WARRIOR_ANIMATION_STEPS, sword_fx)
fighter_2 = Fighter(2, 700, 275, True, WIZARD_DATA, wizard_sheet, WIZARD_ANIMATION_STEPS, magic_fx)
...
while run:
    ...
    draw_text("Enemy: " + str(score[0]), score_font, RED, 20, 60)
    draw_text("Player: " + str(score[1]), score_font, RED, 580, 60)
